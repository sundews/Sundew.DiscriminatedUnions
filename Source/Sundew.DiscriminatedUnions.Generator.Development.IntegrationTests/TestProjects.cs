...
public static class TestProjects
{
    ...
    {
        var project = new CSharpProject(Paths.FindPathUpwards("Sundew.DiscriminatedUnions.Development.Tester")!, new Paths(Paths.FindPathUpwards("Sundew.DiscriminatedUnions")!), new Paths("bin", "obj"));
