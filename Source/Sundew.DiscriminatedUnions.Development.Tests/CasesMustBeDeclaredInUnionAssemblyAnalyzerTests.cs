...
";
        ...
        await VerifyCS.VerifyAnalyzerAsync(
            ...
            VerifyCS.Diagnostic(DiscriminatedUnionsAnalyzer.CasesMustBeDeclaredInUnionAssemblyRule)
                .WithArguments("Unions.DoubleValueExpression", "Sundew.DiscriminatedUnions.Development.TestData")
                .WithSpan(13, 1, 13, 72),
            VerifyCS.Diagnostic(DiscriminatedUnionsAnalyzer.UnnestedCasesShouldHaveFactoryMethodRule)
                .WithArguments("Unions.DoubleValueExpression", "Sundew.DiscriminatedUnions.Development.TestData.IExpression")
                .WithSpan(13, 1, 13, 72));
    }
}