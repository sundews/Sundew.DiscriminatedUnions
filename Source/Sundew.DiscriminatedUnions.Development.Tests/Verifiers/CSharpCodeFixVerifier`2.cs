// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CSharpCodeFixVerifier`2.cs" company="Sundews">
    ...
    where TSuppressor : DiagnosticSuppressor, new()
{
    ...
    public static DiagnosticResult Diagnostic()
        => Microsoft.CodeAnalysis.CSharp.Testing.CSharpCodeFixVerifier<TAnalyzer, TCodeFix, DefaultVerifier>.Diagnostic();
